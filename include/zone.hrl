...
-type zone() :: #zone {id :: integer(), desc :: string(), npc :: [], items :: [{integer(), integer()}], exits :: [exit()]}.

%%-record(npc, {id, name, disp=neutral, damage=3}).
%%-type npc() :: #npc {id :: integer(), name :: string(), disp :: neutral | aggressive, damage :: integer()}.
